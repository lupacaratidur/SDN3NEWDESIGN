            ...
            <div class="col-md-4 col-md-offset-5 p-3">
              <div class="card-berita-2" style="width: 18rem;">
                ...
                <div class="card-body">
                  ...
                  <a href="berita/1.php" class="btn btn-oren">Selengkapnya</a>
                </div>
              </div>
            </div>
            <div class="col-md-4 col-md-offset-5 p-3">
              <div class="card-berita-2" style="width: 18rem;">
                <a href="berita/2.php"><img src="assets/img/berita/impeldown.jpg" class="card-img-top"
                    alt="sambutsiswa.png"></a>
                <div class="card-body">
                  <p> 1 second ago </p>
                  <h6 class="card-title-2">KEGIATAN PEMBIASAAN MENYAMBUT SISWA</h6>
                  <a href="berita/2.php" class="btn btn-oren">Selengkapnya</a>
                </div>
              </div>
            </div>
            <div class="col-md-4 col-md-offset-5 p-3">
              <div class="card-berita-2" style="width: 18rem;">
                <a href="berita/3.php"><img src="assets/img/berita/marinford.jpg" class="card-img-top"
                    alt="daktik.png"></a>
                <div class="card-body">
                  <p> 1 second ago </p>
                  <h6 class="card-title-2">MENERIMA DAK TIK rp 220.000.000,-</h6>
                  <a href="berita/3.php" class="btn btn-oren">Selengkapnya</a>
                </div>
              </div>
            </div>
            <div class="col-md-4 col-md-offset-5 p-3">
              <div class="card-berita-2" style="width: 18rem;">
                <a href="berita/4.php"><img src="assets/img/berita/wano.jpg" class="card-img-top"
                    alt="pemanfaatan.png"></a>
                <div class="card-body">
                  <p> 1 second ago </p>
                  <h6 class="card-title-2">PEMANFAATAN BANTUAN TIK UNTUK KEGIATAN ASESMEN</h6>
                  <a href="berita/4.php" class="btn btn-oren">Selengkapnya</a>
                </div>
              </div>
            </div>
            <div class="col-md-4 col-md-offset-5 p-3">
              <div class="card-berita-2" style="width: 18rem;">
                <a href="berita/5.php"><img src="assets/img/berita/wholecake island.jpg" class="card-img-top"
                    alt="sambutsiswa.png"></a>
                <div class="card-body">
                  <p> 1 second ago </p>
                  <h6 class="card-title-2">KEGIATAN PEMBIASAAN MENYAMBUT SISWA</h6>
                  <a href="berita/5.php" class="btn btn-oren">Selengkapnya</a>
                </div>
              </div>
            </div>
            <div class="col-md-4 col-md-offset-5 p-3">
              <div class="card-berita-2" style="width: 18rem;">
                <a href="berita/6.php"><img src="assets/img/berita/zou.jpg" class="card-img-top" alt="daktik.png"></a>
                <div class="card-body">
                  <p> 1 second ago </p>
                  <h6 class="card-title-2">MENERIMA DAK TIK rp 220.000.000,-</h6>
                  <a href="berita/6.php" class="btn btn-oren">Selengkapnya</a>
                </div>
              </div>
            </div>
          </div>
