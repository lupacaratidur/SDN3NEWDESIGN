...
<!-- Vendor JS Files -->
<script src="<?php echo url_dasar() ?>/assets/vendor/purecounter/purecounter.js"></script>
...
<script src="<?php echo url_dasar() ?>/assets/vendor/waypoints/noframework.waypoints.js"></script>
