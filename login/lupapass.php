      ...
      <main class="form-signin">
        ...
        <form action="forgotpass.php" method="POST">
          ...
          <div class="form-floating">
            <input type="email" name="email" class="form-control mb-3" id="floatingInput"
              placeholder="name@example.com">
            <label for="floatingInput">Alamat Email</label>
          </div>
          <button style="background: #F63854; color: #fff;" class="w-100 btn btn-lg " type="submit">Submit</button>
        </form>
      </main>
    </div>
  </div>
