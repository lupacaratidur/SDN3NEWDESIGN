...
?> <?php
    ...
    if ($op == 'delete') {
      $id = $_GET['id'];
      $sql1 = "delete from tb_visimisi where id = '$id'";
...
<table class="table table-striped">
  ...
  <tbody>
    ...
    $sql1   = "select * from tb_visimisi $sqltambahan";
    ...
    <tr>
      ...
      <td><?php echo $r1['visi'] ?></td>
      <td><?php echo $r1['misi'] ?></td>

      <td>
        <a href="input_visimisi.php?id=<?php echo $r1['id'] ?>">
          <span class="badge bg-warning text-dark">Edit</span>
        </a>

        <a href="crud_visimisi.php?op=delete&id=<?php echo $r1['id'] ?>"
...
<nav aria-label="Page navigation example">
  <ul class="pagination">
    ...
    <li class="page-item">
      <a class="page-link"
        href="crud_visimisi.php?katakunci=<?php echo $katakunci ?>&cari=<?php echo $cari ?>&page=<?php echo $i ?>"><?php echo $i ?></a>
    </li>
    <?php
    }
    ?>
