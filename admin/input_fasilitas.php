...
if (isset($_POST['simpan'])) {
  ...
  if (empty($error)) {
    if ($foto_name) {
      ...
      $foto_name = "fasilitas_" . $foto_name;
    ...
    if ($id != "") {
      $sql1   = "update tb_fasilitas set nama = '$nama',foto='$foto_name',waktu=now() where id = '$id'";
    } else {
      $sql1       = "insert into tb_fasilitas(nama,foto) values ('$nama','$foto_name')";
    }
...
?>
<h1>Halaman Admin Input Data Fasilitas</h1>
<div class="mb-3 row">
  <a href="crud_fasilitas.php">
    << Kembali ke halaman admin Fasilitas</a>
</div>
<?php
if ($error) {
?>
