...
if (isset($_POST['simpan'])) {
  ...
  if (empty($error)) {
    ...
    if ($id != "") {
      $sql1   = "update tb_guruguru set nama = '$nama',foto='$foto_name',waktu=now() where id = '$id'";
    } else {
      $sql1       = "insert into tb_guruguru(nama,foto) values ('$nama','$foto_name')";
    }
...
?>
<h1>Halaman Admin Input Data Guru Guru</h1>
<div class="mb-3 row">
  <a href="crud_guruguru.php">
    << Kembali ke halaman admin Guru Guru</a>
</div>
<?php
if ($error) {
?>
