...
<body class="container">
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="nav-item">
            <a class="nav-link active" href="#">Crud Pendaftaran </a>
          </li>
          <li class="nav-item">
  ...
  <main>
    ...
    if ($op == 'delete') {
      $id = $_GET['id'];
      $sql1 = "select foto from tb_pendaftaran where id = '$id'";
      $q1         = mysqli_query($koneksi, $sql1);
      $r1         = mysqli_fetch_array($q1);
      @unlink("../berita/upload_an/" . $r1['foto']);

      $sql1   = "delete from tb_pendaftaran where id = '$id'";
      $q1     = mysqli_query($koneksi, $sql1);
    ...
    <h1>CRUD PENDAFTARAN</h1>
    <p>
      <a href="input_pendaftaran.php">
        <input type="button" class="btn btn-primary" value="Buat Pendaftar Baru" />
      </a>
    </p>
    <?php
    if ($sukses) {
      ...
      <tbody>
        ...
        if ($katakunci != '') {
          ...
          for ($x = 0; $x < count($array_katakunci); $x++) {
            $sqlcari[] = "(nama_peserta like '%" . $array_katakunci[$x] . "%' or nama_ibu like '%" . $array_katakunci[$x] . "%' )";
          }
          $sqltambahan = "where " . implode(" or ", $sqlcari);
        }

        // Fungsi untuk menampilkan apa yang telah diinput di input_pendaftaran.php
        ...
        <tr>
          ...
          <td><?php echo $r1['nama_peserta'] ?></td>
          <td><?php echo $r1['nik'] ?></td>
          <td><?php echo $r1['alamat'] ?></td>
          <td><?php echo $r1['nama_ibu'] ?></td>
          <td><?php echo $r1['nama_ayah'] ?></td>
          <td></td>
        </tr>
        <!-- sampe sini -->
