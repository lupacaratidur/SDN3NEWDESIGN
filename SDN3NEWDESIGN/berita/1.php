    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrolltoa active" href="../berita.html">Berita</a></li>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4">
            ...
            <div class="row mb-4">
              <div class="col-sm-5">
                <a href="2.html"><img src="../assets/img/berita/marinford.jpg" class="img-thumbnail"
                    alt="sambutsiswa.png"></a>
              </div>
              <div class="col-sm-7">
                <p class="text-muted mb-1" style="font-size: 10px; text-align: right;"><b> 1 second ago </b>
                </p>
                <p style="font-size: 12px; font-weight: 600; margin-bottom: 2px;"><a href="2.html"><b>KEGIATAN
                      PEMBIASAAN MENYAMBUT SISWA</b></a></p>
                <p style="font-size: 10px; margin-bottom: 2px ;">Lorem ipsum dolor sit amet, consectetur
                  adipiscing...</p>
                <a style="font-size: 12px; font-weight: 700;" href="2.html">
                  Readmore
                </a>
              </div>
            </div>
            <div class="row mb-4">
              <div class="col-sm-5">
                <a href="3.html"><img src="../assets/img/berita/wano.jpg" class="img-thumbnail" alt="daktik.png"></a>
              </div>
              <div class="col-sm-7">
                <p class="text-muted mb-1" style="font-size: 10px; text-align: right;"><b> 1 second ago </b>
                </p>
                <p style="font-size: 12px; font-weight: 600; margin-bottom: 2px;"><a href="3.html"><b>MENERIMA DAK TIK
                      rp 220.000.000,-</b></a></p>
                <p style="font-size: 10px; margin-bottom: 2px ;">Lorem ipsum dolor sit amet, consectetur
                  adipiscing...</p>
                <a style="font-size: 12px; font-weight: 700;" href="3.html">
                  Readmore
                </a>
              </div>
            </div>
            <div class="row mb-4">
              <div class="col-sm-5">
                <a href="4.html"><img src="../assets/img/berita/wholecake island.jpg
                                " class="img-thumbnail" alt="pemanfaatan.png"></a>
              </div>
              <div class="col-sm-7">
                <p class="text-muted mb-1" style="font-size: 10px; text-align: right;"><b> 1 second ago </b>
                </p>
                <p style="font-size: 12px; font-weight: 600; margin-bottom: 2px;"><a href="4.html"><b>PEMANFAATAN
                      BANTUAN TIK UNTUK KEGIATAN ASESMEN</b></a></p>
                <p style="font-size: 10px; margin-bottom: 2px ;">Lorem ipsum dolor sit amet, consectetur
                  adipiscing...</p>
                <a style="font-size: 12px; font-weight: 700;" href="4.html">
                  Readmore
                </a>
              </div>
            </div>
            <div class="row mb-4">
              <div class="col-sm-5">
                <a href="5.html"><img src="../assets/img/berita/zou.jpg" class="img-thumbnail"
                    alt="sambutsiswa.png"></a>
              </div>
              <div class="col-sm-7">
                <p class="text-muted mb-1" style="font-size: 10px; text-align: right;"><b> 1 second ago </b>
                </p>
                <p style="font-size: 12px; font-weight: 600; margin-bottom: 2px;"><a href="5.html"><b>KEGIATAN
                      PEMBIASAAN MENYAMBUT SISWA</b></a></p>
                <p style="font-size: 10px; margin-bottom: 2px ;">Lorem ipsum dolor sit amet, consectetur
                  adipiscing...</p>
                <a style="font-size: 12px; font-weight: 700;" href="5.html">
                  Readmore
                </a>
              </div>
            </div>
            <div class="row mb-4">
              <div class="col-sm-5">
                <a href="6.html"><img src="../assets/img/berita/fishman.jpg" class="img-thumbnail" alt="daktik.png"></a>
              </div>
              <div class="col-sm-7">
                <p class="text-muted mb-1" style="font-size: 10px; text-align: right;"><b> 1 second ago </b>
                </p>
                <p style="font-size: 12px; font-weight: 600; margin-bottom: 2px;"><a href="6.html"><b>MENERIMA DAK TIK
                      rp 220.000.000,-</b></a></p>
                <p style="font-size: 10px; margin-bottom: 2px ;">Lorem ipsum dolor sit amet, consectetur
                  adipiscing...</p>
                <a style="font-size: 12px; font-weight: 700;" href="6.html">
                  Readmore
                </a>
              </div>
            </div>
