    ...
    <header id="header" class="d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li class="nav-item">
                        <a class="nav-link active" href="#">Admin Sambutan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Admin Prestasi</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Admin Berita Acara Terbaru</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Admin Guru</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Admin Berita</a>
                    </li>
                    <li><a style="background: #F63854; border-radius: 5px; color: #fff;" class="nav-link scrollto" href="login/login.html">Log Out>></a></li>
                </ul>
